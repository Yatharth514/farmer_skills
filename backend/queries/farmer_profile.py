async def create_farmer_profile(conn,farmer_id:int,village:str,district:str,state:str,pincode:str,lang:str,acres:float,latitude:float,longitude:float):
    return await conn.fetchrow(
        """INSERT INTO farmer_profile(farmer_id,farmer_village,farmer_district,farmer_state,farmer_pincode,preferred_language,farm_acres,farmer_latitude,farmer_longitude)
